    ...
    <table border="1" id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <a href="{{ url('/download/' . urlencode($data->pdf_path)) }}" download style="text-decoration: none; display: inline-block; margin: 10px; padding: 10px 20px; background-color: #3498db; color: #fff; border-radius: 5px; text-align: center;">
